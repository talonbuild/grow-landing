...
export const legalDocs: LegalDoc[] = [
  {
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "These Terms are governed by the laws of the State of Florida, United States, without regard to its conflict of law rules."
      },
      {
        "type": "p",
        "text": "Before starting any formal dispute, please write to us at support@talonapp.co. Most things are resolved that way, quickly. If a dispute cannot be resolved, it will be handled by the state or federal courts located in Florida, and both of us agree to their jurisdiction — unless the law of the place where you live gives you the right to bring it somewhere else, in which case that right stands."
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "If you attach your Apple ID or Google account, we receive a stable identifier from Apple or Google and your email address, so we can recognise you when you come back. If Apple or Google shares the name on your account, we keep it with your account too. We do not receive your password. If you use Sign in with Apple and choose to hide your email, we only ever see the relay address Apple gives us."
      },
      {
        "type": "h",
        "text": "Payments"
      ...
      {
        "type": "p",
        "text": "We record how the app is used — which screens are reached, which steps are completed, whether an action was ticked — along with your device model, its operating system version and the app version, and an approximate location (city, region and country) that our analytics provider, PostHog, works out from your connection's IP address. These events are linked to your GROW account id, not to your name or email. We do not use the location for anything, and we never ask for your precise location."
      },
      {
        "type": "p",
      ...
      },
      {
        ...
        "items": [
          ...
          "No precise location: GROW never asks for GPS or your exact whereabouts.",
      ...
      {
        "type": "p",
        "text": "Three things can outlive the account: records Apple holds about your purchase, which are Apple's and governed by Apple's policy; the record our payments provider RevenueCat keeps of the purchase and its renewals, identified by your account id, so that what was paid can be accounted for and honoured; and anything we must keep by law (for example, tax records of a payment). Analytics events that were already recorded are anonymous once the account they referred to is gone."
      },
      {
        "type": "h",
        "text": "Your rights"
